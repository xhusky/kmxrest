...
public abstract class Assert {
    ...
    public static void hasLength(String text, String message) {
        if (!KmxClientUtils.isBlank(text)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void doesNotContain(String textToSearch, String substring, String message) {
        if (KmxClientUtils.hasLength(textToSearch) && KmxClientUtils.hasLength(substring) &&
    ...
    public static void notEmpty(Object[] array, String message) {
        if (KmxClientUtils.isEmpty(array)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void notEmpty(Collection<?> collection, String message) {
        if (KmxClientUtils.isEmpty(collection)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException(
                    (KmxClientUtils.hasLength(message) ? message + " " : "") +
    ...
    public static void isAssignable(Class<?> superType, Class<?> subType, String message) {
        ...
        if (subType == null || !superType.isAssignableFrom(subType)) {
            throw new IllegalArgumentException((KmxClientUtils.hasLength(message) ? message + " " : "") +
